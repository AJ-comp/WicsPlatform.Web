...
namespace WicsPlatform.Client
{
    public partial class wicsService
    {
        ...
        public async System.Threading.Tasks.Task ExportSchedulePlaysToExcel(Query query = null, string fileName = null)
        {
        ...
        public async System.Threading.Tasks.Task ExportSchedulePlaysToCSV(Query query = null, string fileName = null)
        {
        ...
        partial void OnGetSchedulePlays(HttpRequestMessage requestMessage);

        public async Task<Radzen.ODataServiceResult<WicsPlatform.Server.Models.wics.SchedulePlay>> GetSchedulePlays(Query query)
        {
            return await GetSchedulePlays(filter:$"{query.Filter}", orderby:$"{query.OrderBy}", top:query.Top, skip:query.Skip, count:query.Top != null && query.Skip != null);
        }

        public async Task<Radzen.ODataServiceResult<WicsPlatform.Server.Models.wics.SchedulePlay>> GetSchedulePlays(string filter = default(string), string orderby = default(string), string expand = default(string), int? top = default(int?), int? skip = default(int?), bool? count = default(bool?), string format = default(string), string select = default(string), string apply = default(string))
        {
            var uri = new Uri(baseUri, $"SchedulePlays");
            uri = Radzen.ODataExtensions.GetODataUri(uri: uri, filter:filter, top:top, skip:skip, orderby:orderby, expand:expand, select:select, count:count, apply:apply);

            var httpRequestMessage = new HttpRequestMessage(HttpMethod.Get, uri);

            OnGetSchedulePlays(httpRequestMessage);

            var response = await httpClient.SendAsync(httpRequestMessage);

            return await Radzen.HttpResponseMessageExtensions.ReadAsync<Radzen.ODataServiceResult<WicsPlatform.Server.Models.wics.SchedulePlay>>(response);
        }

        partial void OnCreateSchedulePlay(HttpRequestMessage requestMessage);

        public async Task<WicsPlatform.Server.Models.wics.SchedulePlay> CreateSchedulePlay(WicsPlatform.Server.Models.wics.SchedulePlay schedulePlay = default(WicsPlatform.Server.Models.wics.SchedulePlay))
        {
            var uri = new Uri(baseUri, $"SchedulePlays");

            var httpRequestMessage = new HttpRequestMessage(HttpMethod.Post, uri);

            httpRequestMessage.Content = new StringContent(Radzen.ODataJsonSerializer.Serialize(schedulePlay), Encoding.UTF8, "application/json");

            OnCreateSchedulePlay(httpRequestMessage);

            var response = await httpClient.SendAsync(httpRequestMessage);

            return await Radzen.HttpResponseMessageExtensions.ReadAsync<WicsPlatform.Server.Models.wics.SchedulePlay>(response);
        }

        partial void OnDeleteSchedulePlay(HttpRequestMessage requestMessage);

        public async Task<HttpResponseMessage> DeleteSchedulePlay(ulong id = default(ulong))
        {
            var uri = new Uri(baseUri, $"SchedulePlays({id})");

            var httpRequestMessage = new HttpRequestMessage(HttpMethod.Delete, uri);

            OnDeleteSchedulePlay(httpRequestMessage);

            return await httpClient.SendAsync(httpRequestMessage);
        }

        partial void OnGetSchedulePlayById(HttpRequestMessage requestMessage);

        public async Task<WicsPlatform.Server.Models.wics.SchedulePlay> GetSchedulePlayById(string expand = default(string), ulong id = default(ulong))
        {
            var uri = new Uri(baseUri, $"SchedulePlays({id})");
            ...
            OnGetSchedulePlayById(httpRequestMessage);
        ...
        partial void OnUpdateSchedulePlay(HttpRequestMessage requestMessage);
        
        public async Task<HttpResponseMessage> UpdateSchedulePlay(ulong id = default(ulong), WicsPlatform.Server.Models.wics.SchedulePlay schedulePlay = default(WicsPlatform.Server.Models.wics.SchedulePlay))
        {
            var uri = new Uri(baseUri, $"SchedulePlays({id})");
            ...
            OnUpdateSchedulePlay(httpRequestMessage);
