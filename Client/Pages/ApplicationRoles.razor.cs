...
namespace WicsPlatform.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<WicsPlatform.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(WicsPlatform.Server.Models.ApplicationRole role)
        {
            try
            {
