...
namespace WicsPlatform.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<WicsPlatform.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<WicsPlatform.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(WicsPlatform.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(WicsPlatform.Server.Models.ApplicationUser user)
        {
            try
            {
